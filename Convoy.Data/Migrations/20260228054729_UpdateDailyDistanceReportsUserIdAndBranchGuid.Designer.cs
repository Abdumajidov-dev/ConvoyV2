...
namespace Convoy.Data.Migrations
{
    ...
    [Migration("20260228054729_UpdateDailyDistanceReportsUserIdAndBranchGuid")]
    partial class UpdateDailyDistanceReportsUserIdAndBranchGuid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Convoy.Domain.Entities.AdminNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("IsSent")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "is_sent");
            ...
            modelBuilder.Entity("Convoy.Domain.Entities.DailyDistanceReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("daily_distance_reports");
                });

            modelBuilder.Entity("Convoy.Domain.Entities.DeviceToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("IsPhysicalDevice")
                        .HasColumnType("boolean")
                        .HasColumnName("is_physical_device");
            ...
            modelBuilder.Entity("Convoy.Domain.Entities.UserStatusReport", b =>
                {
                    ...
                    b.Property<bool>("IsNotified")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "is_notified");

                    b.Property<DateTime?>("LastLocationTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_location_time")
                        .HasAnnotation("Relational:JsonPropertyName", "last_location_time");
                    ...
                    b.Property<int>("NotificationCount")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "notification_count");
                    ...
                    b.HasIndex("LastLocationTime");

                    b.HasIndex("LastNotifiedAt");

                    b.HasIndex("UserId");

                    b.ToTable("user_status_reports");
                });

            modelBuilder.Entity("Convoy.Domain.Entities.UserStoppedReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("StoppedDurationMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("stopped_duration_minutes");
                    ...
                    b.ToTable("user_stopped_reports");
                });

            modelBuilder.Entity("Convoy.Domain.Entities.AdminNotification", b =>
                {
                    b.HasOne("Convoy.Domain.Entities.User", "AdminUser")
                        .WithMany()
